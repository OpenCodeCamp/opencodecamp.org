        ...
        public async Task<R> Handle(IdentifiedCommand<T, R> message, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    switch (command)
                    {
                        case SubscribeToNewsletterCommand subscribeToNewsletterCommand:
                            idProperty = nameof(subscribeToNewsletterCommand.EmailAddress);
                            commandId = subscribeToNewsletterCommand.EmailAddress;
                            break;
